...
ggarrange(plotlist=list(F2A.ggplot, F2B.ggplot), ncol=1, labels=c("A", "B"), heights=c(0.45, 0.55)) %>% {ggsave(filename="./vConvFigmain/result/Supplementary.Fig.5/Supplementary.Fig.5.png", plot=., device="png", width=20, height=18, units="cm")}
