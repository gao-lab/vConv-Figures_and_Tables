...
def main():
    ...
    KernelMotifPath = "../../../output/result/BassetCompare/NineVCNN/KernelInfulence/PWM/recover_PWM/"
    GenerateMemeFormat(KernelMotifPath, "../../../output/result/BassetCompare/NineVCNN/KernelInfulence/PWM/memeformatall.txt")
    ...
    #
    KernelMotifPath = "../../../output/result/BassetCompare/basset/output/PWM/recover_PWM/"
    GenerateMemeFormat(KernelMotifPath, "../../../output/result/BassetCompare/basset/output/PWM/memeformatall.txt")
