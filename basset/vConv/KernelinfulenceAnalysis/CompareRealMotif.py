...
def paralleltomtom():
    ...
    """
    path = "../../../output/result/BassetCompare/NineVCNN/KernelInfulence/"
    target_motif_file = "../../../data/data_basset/HOCOMOCOv11_core_HUMAN_mono_meme_format.meme"
    query_motif_file = "../../../output/result/BassetCompare/NineVCNN/KernelInfulence/PWM/memeformatall.txt"
    OutputPath = path + "/tomtom/"
    runTomTom(query_motif_file, target_motif_file, OutputPath)

    path = "../../../output/result/BassetCompare/basset/output/"
    query_motif_file = "../../../output/result/BassetCompare/basset/output/PWM/memeformatall.txt"
    OutputPath = path + "/tomtom/"
    runTomTom(query_motif_file, target_motif_file, OutputPath)
